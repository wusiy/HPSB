...
import com.sunland.libusbcamera.R;
...
public class UVCCameraHelper {
    ...
    public static final int UVC_BRIGHTNESS = UVCCamera.PU_BRIGHTNESS; //亮度
    public static final int UVC_CONTRAST = UVCCamera.PU_CONTRAST; //对比度
    public static final int UVC_HUE = UVCCamera.PU_HUE; //色调
    public static final int UVC_SATURATION = UVCCamera.PU_SATURATION; //饱和度
    public static final int UVC_SHARPNESS = UVCCamera.PU_SHARPNESS; //锐度
    public static final int UVC_GAMMA = UVCCamera.PU_GAMMA; //伽马
    public static final int UVC_WB_TEMP = UVCCamera.PU_WB_TEMP; //白平衡温度
    public static final int UVC_PU_WB_COMPO = UVCCamera.PU_WB_COMPO; //白平衡分量
    public static final int UVC_BACKLIGHT = UVCCamera.PU_BACKLIGHT; //背光补偿
    public static final int UVC_GAIN = UVCCamera.PU_GAIN; //增益

    public static final int UVC_AUTO_CONTRAST = UVCCamera.PU_CONTRAST_AUTO; //是否自动对比度
    public static final int UVC_AUTO_HUE = UVCCamera.PU_HUE_AUTO; //是否自动色调;
    public static final int UVC_AUTO_FOCUS = UVCCamera.CTRL_FOCUS_AUTO; //是否自动对焦


    public static final int UVC_ZOOM = UVCCamera.CTRL_ZOOM_ABS; //缩放
    public static final int UVC_FOCUS = UVCCamera.CTRL_FOCUS_ABS; //对焦

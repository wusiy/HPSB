...
public class DialogHelp {
    ...
    public static ProgressDialog getWaitDialog(Context context, String message) {
        ProgressDialog waitDialog = new ProgressDialog(context, R.style.Theme_AlertDialog);
     ...
     * @return
     */
    public static ProgressDialog getWaitWithTitleDialog(Context context, String title, String message) {
        ProgressDialog waitDialog = new ProgressDialog(context, R.style.Theme_AlertDialog);
        waitDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);//设置风格为圆形进度条
    ...
    public static AlertDialog.Builder getMessageOkDialog(Context context, String title, String message, DialogInterface.OnClickListener onClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setTitle(title);
        builder.setMessage(message);
        builder.setPositiveButton("确定", onClickListener);
    ...
    public static AlertDialog.Builder getMessageOkDialog(Context context, String title, String message) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setTitle(title);
        builder.setMessage(message);
    ...
    public static AlertDialog.Builder getMessageCancelDialog(Context context, String title, String message, DialogInterface.OnClickListener onCancleClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setTitle(title);
        builder.setMessage(message);
     ...
     * @return
     */
    public static AlertDialog.Builder getCustomViewDialog(Context context, String title, String message, View view, DialogInterface.OnClickListener onOkClickListener, DialogInterface.OnClickListener onCancleClickListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setTitle(title);
        builder.setMessage(message);
    ...
    public static AlertDialog.Builder getMessageTipDialog(Context context, String title, String message) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setTitle(title);
        builder.setMessage(message);
     ...
     * @return
     */
    public static ProgressDialog createDownloadProgressDialog(Context context, String title, DialogInterface.OnClickListener cancelListener){
        ProgressDialog progressDlg = new ProgressDialog(context,R.style.Theme_AlertDialog);
        progressDlg.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
        progressDlg.setButton("取消", cancelListener);
